...
@Component({
  selector: 'app-code40-p17-termination-value-of-intangible-depreciating-asset',
  templateUrl: './code40-p17-termination-value-of-intangible-depreciating-asset.component.html',
  styleUrls: ['./code40-p17-termination-value-of-intangible-depreciating-asset.component.css']
})
export class Code40P17TerminationValueOfIntangibleDepreciatingAssetComponent implements OnInit {
  incomeTypeId: string = "";
    ...
    this.commonRequest.getTwoIds().subscribe((data) => {
      ...
      this.commonRequest.getMainForm(this.mainFormId).subscribe((infor) => {
        if (infor['incomeDetailsForm']){
          this.fetchData(infor['incomeDetailsForm']['incomeTypeDetails'], "40", "p17TerminationValueOfIntangibleDepreciatingAsset", "p17TerminationValueOfIntangibleDepreciatingAssetId") ///
        }
      })
    })
  }
