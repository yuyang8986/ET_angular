...
@Component({
  selector: 'app-code41-p18-termination-value-of-other-depreciating-assets',
  templateUrl: './code41-p18-termination-value-of-other-depreciating-assets.component.html',
  styleUrls: ['./code41-p18-termination-value-of-other-depreciating-assets.component.css']
})
export class Code41P18TerminationValueOfOtherDepreciatingAssetsComponent implements OnInit {
  incomeTypeId: string = "";
    ...
    this.commonRequest.getTwoIds().subscribe((data) => {
      ...
      this.commonRequest.getMainForm(this.mainFormId).subscribe((infor) => {
        if (infor['incomeDetailsForm']){
          this.fetchData(infor['incomeDetailsForm']['incomeTypeDetails'], "41", "p18TerminationValueOfOtherDepreciatingAssets", "p18TerminationValueOfOtherDepreciatingAssetsId") ///
        }
      })
    })
  }
