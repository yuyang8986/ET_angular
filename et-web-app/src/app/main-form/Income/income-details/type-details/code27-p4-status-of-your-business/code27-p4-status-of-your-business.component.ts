...
@Component({
  selector: 'app-code27-p4-status-of-your-business',
  templateUrl: './code27-p4-status-of-your-business.component.html',
  styleUrls: ['./code27-p4-status-of-your-business.component.css']
})
export class Code27P4StatusOfYourBusinessComponent implements OnInit {
  incomeTypeId: string = "";
    ...
    this.commonRequest.getTwoIds().subscribe((data) => {
      ...
      this.commonRequest.getMainForm(this.mainFormId).subscribe((infor) => {
        if (infor['incomeDetailsForm']){
          this.fetchData(infor['incomeDetailsForm']['incomeTypeDetails'], "27", "p4StatusOfBusiness", "P4StatusOfBusinessId") ///
        }
      })
    })
  }
